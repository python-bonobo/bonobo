# # Generated by Medikit 0.8.0 on 2022-07-12.
...
#     extras_require={
#         'dev': [
#             'cookiecutter ~= 2.1.1', 'coverage ~= 4.5', 'pytest ~= 4.6',
#             'pytest-cov ~= 2.7', 'pytest-timeout ~= 2.1.0', 'sphinx ~= 1.7',
...
# def get_version():
#     version = open("civis_integration/_version.py", "r").read()
#     # this is certainly not exhaustive for pep 440
#     regex = r"(?P<major>\d+)(.(?P<minor>\d+))?(.(?P<micro>\d+))?"
